...
#         self.final = ConvModule(feat_channel, num_classes, kernel_size=1)
#
#         # Softmax to pass into decoder
...
#         self.down45 = nn.MaxPool2d(2)
#
#         # Up-conv 2x2
#         self.up56 = nn.ConvTranspose2d(16 * feat_channel, 8 * feat_channel, kernel_size=2, stride=2, output_padding=1)
#         self.up67 = nn.ConvTranspose2d(8 * feat_channel, 4 * feat_channel, kernel_size=2, stride=2, output_padding=1)
#         self.up78 = nn.ConvTranspose2d(4 * feat_channel, 2 * feat_channel, kernel_size=2, stride=2)
#         self.up89 = nn.ConvTranspose2d(2 * feat_channel, feat_channel, kernel_size=2, stride=2)
#
#
#     def forward(self, x):
#         # Going down the U
