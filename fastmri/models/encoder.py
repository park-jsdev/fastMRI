...
class Encoder(nn.Module):
    def __init__(self, feat_channel=64, in_channels=3, num_classes=5):
        ...
        # Up-conv 2x2
        self.up56 = nn.ConvTranspose2d(16 * feat_channel, 8 * feat_channel, kernel_size=2, stride=2)
        self.up67 = nn.ConvTranspose2d(8 * feat_channel, 4 * feat_channel, kernel_size=2, stride=2)
