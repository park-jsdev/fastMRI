...
from fastmri.pl_modules import FastMriDataModule, AttentionUnetModule
import yaml
...
def build_args():
    ...
    # module config
    parser = AttentionUnetModule.add_model_specific_args(parser)
    parser.set_defaults(
    ...
    checkpoint_dir = args.default_root_dir / "checkpoints_attention_unet"
    if not checkpoint_dir.exists():
        checkpoint_dir.mkdir(parents=True)

    args.callbacks = [
        pl.callbacks.ModelCheckpoint(
            dirpath=args.default_root_dir / "checkpoints_attention_unet",
            save_top_k=True,
            verbose=True,
